// Intent detection is now handled by the backend LLM
// All messages go to the chat API and the LLM decides the appropriate action
function detectAnalyzeIntent(text) {
  // Always return null - let backend LLM handle intent detection
  return null;
}
